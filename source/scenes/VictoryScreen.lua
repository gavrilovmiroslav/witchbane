VictoryScreen = {}
class("VictoryScreen").extends(GenericScene)
local scene = VictoryScreen
...
function scene:drawCard(_name, _x, _y)
	...
	Graphics.drawInvertedTextAligned("VICTORY", _x + w / 2, _y + h / 2 + 68, kTextAlignment.center)
end
...
function scene:update()
	...
	local w, h = playdate.display.getSize()
	-- maybe draw victory text
	self:drawCard(Victory, 0, 0)
